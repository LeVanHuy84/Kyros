...
import { Search, Loader2, Trash2, Edit2, Check } from 'lucide-react';
...
export const MemoryVaultPanel: React.FC<MemoryVaultPanelProps> = ({
  onSuccess,
  onError,
}) => {
  const {
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          Semantic memory context extracted from your completed sessions. Audit,
                    ...
                    {editingMemoryId === entry.id ? (
                      ...
                      >
                        ...
                        >
                          <div
                            style={{
                              width: `${entry.confidenceScore * 100}%`,
                              height: '100%',
                              backgroundColor:
