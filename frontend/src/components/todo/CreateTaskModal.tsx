...
interface CreateTaskModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (title: string, description: string, priority: 'High' | 'Medium' | 'Low', dueDate: string | null, tags: string[]) => Promise<void>;
  isSaving: boolean;
}
    ...
    <div style={{
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h3 style={{ fontSize: '20px', fontWeight: '600', color: 'var(--text-main)', margin: 0 }}>Create Workspace Task</h3>
          <button 
            type="button" 
            onClick={onClose}
