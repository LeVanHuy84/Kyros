    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div style={{
        ...
        <div style={{
          ...
          {[
            { id: 'pref', label: 'Preferences', icon: <SettingsIcon size={16} /> },
            { id: 'vault', label: 'Memory Vault', icon: <Brain size={16} /> },
            { id: 'conv', label: 'Conversations', icon: <MessageSquare size={16} /> },
            { id: 'notif', label: 'Notifications', icon: <BellRing size={16} /> },
            { id: 'ws', label: 'Workspace Settings', icon: <Briefcase size={16} /> }
          ].map((tab) => (
            <button
              key={tab.id}
        ...
        <div style={{ padding: '32px', minHeight: '300px' }}>
          {activeSubTab === 'pref' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px', maxWidth: '280px' }}>
                <label htmlFor="theme-select" style={{ fontSize: '14px', fontWeight: '600', color: 'var(--text-muted)' }}>Interface Theme Mode</label>
                <select
                   id="theme-select"
                   value={theme}
          ...
          {activeSubTab === 'notif' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <h4 style={{ margin: 0, fontSize: '18px', fontWeight: '600' }}>Notification Settings</h4>
              <p style={{ fontSize: '15px', color: 'var(--text-muted)', margin: 0, lineHeight: '1.6' }}>
          ...
          {activeSubTab === 'ws' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <h4 style={{ margin: 0, fontSize: '18px', fontWeight: '600' }}>Workspace Configurations</h4>
              <p style={{ fontSize: '15px', color: 'var(--text-muted)', margin: 0, lineHeight: '1.6' }}>
