  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div className="card">
        ...
        >
          Global registry of tenant workspace segments. Operator is permitted to
          suspend operations, audit sizes, or configure custom rate limit
          profiles.
        </p>
              ...
              {[
                {
                  ...
                  uuid: 'workspace-demo-uuid',
                  status: 'ACTIVE',
                },
                {
                  name: 'Marketing Workspace',
                  uuid: 'workspace-marketing-uuid',
                  status: 'ACTIVE',
                },
                {
                  name: 'Archived Workspace',
                  uuid: 'workspace-suspended-uuid',
                  status: 'SUSPENDED',
                },
              ].map((row, idx) => (
                <tr
