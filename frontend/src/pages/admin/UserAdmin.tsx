  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div className="card">
        ...
        >
          Platform operator administrative console to update roles, audit
          sign-in telemetry, unlock accounts, or edit registration parameters.
        </p>
          ...
          >
            ...
            <tbody>
              {[
                {
                  name: 'Operator Jane',
                  email: 'operator@assistant.ai',
                  roles: 'USER, SYSTEM_OPERATOR',
                  status: 'Active',
                },
                {
                  name: 'Jane Doe',
