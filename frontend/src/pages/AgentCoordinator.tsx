  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      ...
      <div className="card interactive-card">
        ...
        >
          The cognitive planner parses instructions through the low-latency LLM
          pipeline. Any destructive or external integration tool execution is
          paused until manual operator clearance (AD-005).
        </p>
