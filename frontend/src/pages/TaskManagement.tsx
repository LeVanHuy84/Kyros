  ...
  if (!activeWorkspace) {
    return (
      <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-muted)' }}>
        ...
        <h3 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--text-main)' }}>No Active Workspace</h3>
        <p style={{ fontSize: '15px' }}>Please select or create a workspace from the top sidebar to access Task Management.</p>
      </div>
    );
  }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '20px' }}>
        <div>
          <h2 style={{ fontSize: '26px', fontWeight: '600', color: 'var(--text-main)', margin: '0 0 8px 0', letterSpacing: '-0.5px' }}>
            Tasks & Orchestration
          </h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '15px', margin: 0, maxWidth: '600px', lineHeight: '1.6' }}>
            Coordinate tasks, monitor automated recurrence rules, and manage workspace priorities.
          </p>
        </div>
      ...
      <div className="card" style={{ padding: '24px', gap: '24px' }}>
        ...
        {isLoading ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 0', gap: '12px' }}>
            ...
            <span style={{ color: 'var(--text-muted)', fontSize: '15px' }}>Loading tasks...</span>
          </div>
        ) : tasks.length === 0 ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '60px 0', gap: '16px', textAlign: 'center' }}>
            <ListTodo size={40} style={{ opacity: 0.25, color: 'var(--text-muted)' }} />
            <div>
              <h4 style={{ fontSize: '16px', fontWeight: '600', margin: '0 0 6px 0', color: 'var(--text-main)' }}>No Tasks Found</h4>
